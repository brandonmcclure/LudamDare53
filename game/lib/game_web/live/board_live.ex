defmodule GameWeb.BoardLive do
  ...
  def mount(_params, _session, socket) do
    ...
    starting_board = [
      ...
      %{"x" => 1, "y" => 2, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 1, "y" => 3, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 1, "y" => 4, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 1, "y" => 5, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{
        "x" => 1,
        "y" => 6,
        "cell_type" => "border",
        "status" => :rand.uniform(6),
        "walkable" => 0
      },
      %{
        "x" => 2,
      ...
      %{"x" => 2, "y" => 2, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 2, "y" => 3, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 2, "y" => 4, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 2, "y" => 5, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{
        "x" => 2,
        "y" => 6,
        "cell_type" => "border",
      ...
      %{"x" => 3, "y" => 2, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 3, "y" => 3, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 3, "y" => 4, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 3, "y" => 5, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{
        "x" => 3,
        "y" => 6,
        "cell_type" => "border",
      ...
      %{"x" => 4, "y" => 2, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 4, "y" => 3, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 4, "y" => 4, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 4, "y" => 5, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{
        "x" => 4,
        "y" => 6,
        "cell_type" => "border",
      ...
      %{"x" => 5, "y" => 2, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 5, "y" => 3, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 5, "y" => 4, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 5, "y" => 5, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{
        "x" => 5,
        "y" => 6,
        "cell_type" => "border",
      ...
      %{"x" => 6, "y" => 2, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 6, "y" => 3, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 6, "y" => 4, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
      %{"x" => 6, "y" => 5, "cell_type" => "road", "status" => :rand.uniform(6), "walkable" => 0},
