defmodule TestCounterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TestCounterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TestCounterWeb.Gettext, "errors", msg, opts)
    end
  end
